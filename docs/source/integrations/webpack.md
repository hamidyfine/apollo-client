...
[Jest](https://facebook.github.io/jest/) can't use the Webpack loaders. To make the same transformation work in Jest, use [jest-graphql-transformer](https://www.npmjs.com/package/jest-graphql-transformer).
